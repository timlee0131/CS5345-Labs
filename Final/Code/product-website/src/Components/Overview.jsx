...
function Overview() {
    return (
        <div class="jumbotron">
            ...
            <p class="lead">
                <a href="./../Emscripten/frontend/sort.html" target="_blank"><Button size='lg' variant="dark">Demo Web App</Button></a>{' '}
                <Button size='lg' variant="dark">Download Native App</Button>
            </p>
        </div>
    )
}
